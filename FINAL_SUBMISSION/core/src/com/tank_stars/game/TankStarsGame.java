...
import com.tank_stars.game.Screens.MainMenuScreen;
import com.tank_stars.game.Screens.SavedGamesScreen;
...
public class TankStarsGame extends Game implements Serializable {
	...
	private SavedGamesScreen savedGamesScreen;
...
//		new_game_button=new Texture(Gdx.files.internal("new_game_button.jpg"));
		...
		savedGamesScreen=SavedGamesScreen.get_saved_games_instance(this);
		setScreen(new MainMenuScreen(this));		//TRYING WITH SCREENS, REMEMBER TO DELETE THIS AND UNCOMMENT OLDER PART IF THIS DOESN'T WORK
...
//		batch.end();
	...
	public SavedGamesScreen getSavedGamesScreen(){
